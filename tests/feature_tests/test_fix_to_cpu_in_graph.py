...
from magi_compiler.magi_backend.magi_backend import _device_is_cpu
from magi_compiler.magi_backend.magi_backend import fix_graph_device_placement as _fix
